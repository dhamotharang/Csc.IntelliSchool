...
#warning Register COM first
    ...
    private static void LoadLog() {
      ...
      var logRecords = DeviceProxy.GetLog(_terminal.IP, _terminal.Port.Value, _terminal.MachineID.Value, _terminal.Password.Value);
    ...
    private static void ClearLog() {
      ...
      DeviceProxy.ClearLog(_terminal.IP, _terminal.Port.Value, _terminal.MachineID.Value, _terminal.Password.Value);
